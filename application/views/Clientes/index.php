                         ...
                         <div class="row">
                           <div class="col-md-4 col-sm-12">
                             ...
                             <div class="form-group">
                               <select v-model="form.tipo_cliente" @change="tipoCliente()" v-validate="'required'"  name="tipo_cliente" class="form-control" :disabled="ver" >
                                <option value=""></option>
                                <option value="Persona natural">Persona natural</option>
                                <option value="Persona jurídica">Persona jurídica</option>
                               </select>
                               <p class="text-danger my-1 small" v-if="(errors.first('tipo_cliente'))" >  Este dato es requerido/o es inválido  </p>
                             </div>
                           </div>
                           <div class="col-md-4 col-sm-12">
...
<script>
     ...
     new Vue({
       ...
       methods: {
           ...
           tipoCliente(){
             if (this.form.tipo_cliente==='Persona natural') {
               this.form.nit_cliente="No aplica";
               this.form.nombre_empresa="No aplica";
               this.form.r_legal="No aplica";
             }else{
