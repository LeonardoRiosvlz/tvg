            ...
            <div class="carousel-item" v-for="envios in envios">
              <div class="card" style="width:100%;opacity:0.9;background-color:#2458c3ed!important">
                  <div class="card-body">
                    ...
                    <p class="card-text links text-white">Ciudad:</p>
                    <p class="card-text links text-white">Fecha de envío:</p>
            ...
            <div v-for="pagos in pagos"  class="carousel-item  " style="">
              <div class="card " style="width:100%;opacity:0.9;background-color:#f27474!important">
                <div class="card-body">
                  ...
                  <h4 class="card-title links text-white"></h4>
                  <p class="card-text links text-white">Ciudad:</p>
                  <p class="card-text links text-white">Transporte:</p>
                  <p class="card-text links text-white">Valor:</p>
                  <p v-if="pagos.descuento>0" class="card-text links text-white">Descuento:</p>
                  <p v-if="pagos.descuento>0" class="card-text links text-white">Cupon:</p>
                </div>
              </div>
            </div>
          </div>
