          ...
          <thead>
            <tr>
              <th scope="col" colspan="5" class="border-0 bg-white  text-center">
                  <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold links">Datos de la empresa <i class="fa fa-sitemap" aria-hidden="true"></i></div>
              </th>
            </tr>
          </thead>
        </table>
        ...
        <form role="form" id="form" @submit.prevent="validateBeforeSubmit">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="links">Nit</label>
                 <input type="text" v-model="form.nit" v-validate="'required'" name="nit" class="form-control" id="" placeholder="" :disabled="ver">
                <p class="text-danger my-1" v-if="(errors.first('nit'))" >  Este dato es requerido  </p>
              </div>
            </div>
            <div class="col-sm-4">
              <!-- textarea -->
              <div class="form-group">
                <label class="links">PBX</label>
                 <input type="text" v-model="form.pbx" v-validate="'required'" name="pbx" class="form-control" id="" placeholder="" :disabled="ver">
                <p class="text-danger my-1" v-if="(errors.first('pbx'))" >  Este dato es requerido  </p>
              </div>
            </div>
            <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            ...
            <div class="form-group">
              <label class="links">Dirección</label>
               <textarea type="text" v-model="form.direccion" v-validate="'required'" name="direccion" rows="5" class="form-control" id="" :disabled="ver"></textarea>
              <p class="text-danger my-1" v-if="(errors.first('direccion'))" >  Este dato es requerido  </p>
            </div>
          </div>
          <div class="col-sm-6 row">
            <div class="col-sm-12">
              ...
              <div class="form-group">
                <label class="links">Teléfono</label>
                 <input type="number" v-model="form.telefono_uno" v-validate="'required'" name="telefono_uno" class="form-control" id="" :disabled="ver">
                <p class="text-danger my-1" v-if="(errors.first('telefono_uno'))" >  Este dato es requerido  </p>
              </div>
            </div>
            <div class="col-sm-6">
              <!-- textarea -->
              <div class="form-group">
                <label class="links">Teléfono #2</label>
                 <input type="number" v-model="form.telefono_dos" v-validate="'required'" name="telefono_dos" class="form-control" id="" :disabled="ver">
                <p class="text-danger my-1" v-if="(errors.first('telefono_dos'))" >  Este dato es requerido  </p>
              </div>
            </div>
            <div class="col-sm-6">
              <!-- textarea -->
              <div class="form-group">
                <label class="links">Teléfono Movil</label>
                 <input type="number" v-model="form.celular" v-validate="'required'" name="celular" class="form-control" id="" :disabled="ver">
                <p class="text-danger my-1" v-if="(errors.first('celular'))" >  Este dato es requerido  </p>
              </div>
            </div>
          </div>
            ...
            <div class="col-sm-6">
              ...
              <div class="form-group">
                <label class="links">Email</label>
                 <input type="email" v-model="form.email" v-validate="'required|email'" name="email" class="form-control" id="" :disabled="ver">
            ...
            <div class="col-sm-6">
              <!-- textarea -->
              <div class="form-group">
                <label class="links">Pagina web</label>
                 <input type="texto" v-model="form.web" v-validate="'required|url'" name="web" class="form-control" id="" :disabled="ver">
       ...
       methods: {
           ...
           validateBeforeSubmit() {
                   this.$validator.validateAll().then((result) => {
                     ...
                     if(!this.editMode){
                       axios.post('index.php/empresa/insertar',data)
                       .then(response => {
                       ...
                       axios.post('index.php/DatosEmpresa/editar',data)
                       .then(response => {
                         if(response.data.status == 200)
                         {
                           this.loadempresa();
                 ...
                 eliminarempresa(index){
                   Swal({
                     ...
                     if (result.value) {
                       let data = new FormData();
                       data.append('id',this.empresa[index].id);
                         axios.post('index.php/empresa/eliminar',data)
                         .then(response => {
                           if(response) {
                             Swal(
                               '¡Eliminado!',
                 ...
                 setear(index){
                       this.form.nombre_empresa=this.empresa[0].nombre_empresa,
                       this.form.descripcion=this.empresa[0].descripcion,
                       this.form.direccion=this.empresa[0].direccion,
                       this.form.telefono=this.empresa[0].telefono,
                       this.form.celular=this.empresa[0].celular,
                       this.form.email=this.empresa[0].email,
                       this.form.pbx=this.empresa[0].pbx,
                       this.form.nit=this.empresa[0].nit,
                       this.form.telefono_uno=this.empresa[0].telefono_uno,
                       this.form.telefono_dos=this.empresa[0].telefono_dos,
