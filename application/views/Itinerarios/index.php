      ...
      <div class="table-responsive ">
        <table id="example2" class="table">
          <thead>
            <tr>
              <th scope="col" colspan="5" class="border-0 bg-white  text-center">
                  <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold links">Itinerarios <i class="fa fa-align-centerr" aria-hidden="true"></i></div>
              </th>
            </tr>
            <tr>
          ...
          <table id="example1" class="table ">
            <thead>
            <tr>
              <th class="links">Nombre del itinerario</th>
                <th class="links">Action</th>
            </tr>
            </thead>
              <tr v-for="(itinerarios,index) in itinerarios">
                <td class="links">{{itinerarios.nombre_itinerario}}</td>
                  <td>
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-default dropdown-toggle dropdown-icon" data-toggle="dropdown">
                          ...
                          <div class="dropdown-menu" role="menu">
                            ...
                            <a class="dropdown-item" href="#" @click="eliminaritinerarios(index)">Eliminar</a>
                          </div>
                        </button>
                    </div>
                  </td>
         ...
         <div class="modal-dialog modal-lg">
           <div class="modal-content">
             <div class="modal-header">
               <h4 class="modal-title links">Gestión de itinerarios  <i class="fa fa-align-center" aria-hidden="true"></i></h4>
                         ...
                         <div class="row">
                             <div class="col-sm-12">
                               ...
                               <div class="form-group">
                                 <label class="links">Nombre itinerarios</label>
                                  <input type="text" v-model="form.nombre_itinerario" v-validate="'required'" name="nombre_itinerarios" class="form-control" id="" :disabled="ver">
                                 <p class="text-danger my-1" v-if="(errors.first('nombre_itinerarios'))" >  Este dato es requerido  </p>
                               </div>
                             </div>
                            </div>
     ...
     new Vue({
       ...
       methods: {
           ...
           validateBeforeSubmit() {
                 ...
                 setear(index){
                   this.form.id=this.itinerarios[index].id,
                   this.form.nombre_itinerario=this.itinerarios[index].nombre_itinerario,
                   $('#modal-lg').modal('show');
                   this.editMode=true
                 },
                 ver(index){
