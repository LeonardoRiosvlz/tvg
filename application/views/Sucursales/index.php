      ...
      <div class="table-responsive ">
          ...
          <thead>
            <tr>
              <th scope="col" colspan="5" class="border-0 bg-white  text-center">
                  <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold links">Sucursales <i class="fa fa-university" aria-hidden="true"></i></div>
              </th>
            </tr>
            <tr>
        ...
        <table id="example1" class="table ">
          ...
          <tr>
            ...
            <tr v-for="(sucursales,index) in sucursales">
              <td class="links">{{sucursales.nombre_sucursal}}</td>
              <td class="links">{{sucursales.descripcion}}</td>
              <td class="links">{{sucursales.departamento}}</td>
              <td class="links">{{sucursales.ciudad}}</td>
              <td>
                <div class="btn-group">
         ...
         <div class="modal-dialog modal-lg">
           <div class="modal-content">
             <div class="modal-header">
               <h4 class="modal-title links">Sucursales <i class="fa fa-university" aria-hidden="true"></i></h4>
                         ...
                         <div class="row">
                           <div class="col-sm-6">
                             ...
                             <div class="form-group">
                               <label class="links">Nombre sucursales</label>
                                <input type="text" v-model="form.nombre_sucursal" v-validate="'required'" name="nombre_sucursal" class="form-control" id="" :disabled="ver">
                               <p class="text-danger my-1" v-if="(errors.first('nombre_sucursal'))" >  Este dato es requerido  </p>
                             </div>
                           </div>
                           <div class="col-sm-6">
                             <!-- textarea -->
                             <div class="form-group">
                               <label class="links">Descripción</label>
                                <input type="text" v-model="form.descripcion" v-validate="'required'" name="descripcion" class="form-control" id="" placeholder="" :disabled="ver">
                         ...
                         <div class="col-sm-12">
                           ...
                           <div class="form-group">
                             <label class="links">Dirección</label>
                              <input type="text" v-model="form.direccion" v-validate="'required'" name="direccion" class="form-control" id="" :disabled="ver">
                           ...
                           <div class="col-sm-6">
                             ...
                             <div class="form-group">
                               <label class="links">Teléfono</label>
                                <input type="number" v-model="form.telefono" v-validate="'required'" name="telefono" class="form-control" id="" :disabled="ver">
     ...
     new Vue({
       ...
       methods: {
           ...
           validateBeforeSubmit() {
                 ...
                 setear(index){
                       this.form.id=this.sucursales[index].id,
                       this.form.nombre_sucursal=this.sucursales[index].nombre_sucursal,
                       this.form.descripcion=this.sucursales[index].descripcion,
                       this.form.direccion=this.sucursales[index].direccion,
                       this.form.telefono=this.sucursales[index].telefono,
                       this.form.celular=this.sucursales[index].celular,
                       this.form.email=this.sucursales[index].email,
                       this.form.dep=this.sucursales[index].dep,
                       this.form.ciudad=this.sucursales[index].ciudad,
                       this.form.departamento=this.sucursales[index].departamento,
                       $('#modal-lg').modal('show');
                       this.editMode=true
                 },
                 ver(index){
                   this.form.id=this.sucursales[index].id,
                   this.form.nombre_sucursales=this.sucursales[index].nombre_sucursales,
                   this.form.descripcion=this.sucursales[index].descripcion,
                   this.form.direccion=this.sucursales[index].direccion,
                   this.form.telefono=this.sucursales[index].telefono,
                   this.form.celular=this.sucursales[index].celular,
