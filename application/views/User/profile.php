                       ...
                       <form role="form" id="form" @submit.prevent="validateBeforeSubmit">
                        <div class="form-group pl-4 pr-4 row">
                          ...
                          <div class="form-group col-6">
                            ...
                            <input v-model="form.telefono" v-validate="'required'" name="telefono" type="text" class="form-control" id="" placeholder="">
                            <p class="text-danger my-1" v-if="(errors.first('telefono'))" >  Este dato es requerido  </p>
                          </div>
                          <div class="form-group col-6">
                            <label class="links">Departamento</label>
                            <select v-model="form.dep" @change="depp()" name="dep" class="form-control" >
                              <option v-for="colombia in colombia" :value="colombia.id">{{colombia.departamento}}</option>
                            </select>
                            <p class="text-danger my-1" v-if="(errors.first('dep'))" >  Este dato es requerido  </p>
                          </div>
                          <div class="form-group col-6">
                            <label class="links">Ciudad</label>
                           <select v-model="form.ciudad" v-validate="'required'" name="ciudad" class="form-control" >
                          ...
                          <div class="form-group col-6">
                            <label  class="links">Dirección de facturación</label>
                              <textarea v-model="form.direccion_facturacion" v-validate="'required'" name="direccion_facturacion" class="form-control" id="exampleFormControlTextarea1" rows="1"></textarea>
                            <p class="text-danger my-1" v-if="(errors.first('direccion_facturacion'))" >  Este dato es requerido  </p>
                          </div>
                          <div class="form-group col-6">
                            <label  class="links">Dirección envío</label>
                              <textarea v-model="form.direccion_envio" v-validate="'required'" name="direccion_envio" class="form-control" id="exampleFormControlTextarea1" rows="1"></textarea>
                            <p class="text-danger my-1" v-if="(errors.first('direccion_envio'))" >  Este dato es requerido  </p>
                          </div>
                          <div class="form-group col-12">
                            <label  class="links">Eres profesional de la estética</label>
                              <select v-model="form.profesional" v-validate="'required'" name="profesional" class="form-control" >
                                <option value="Si">Si</option>
                                <option value="No">No</option>
                              </select>
                            <p class="text-danger my-1" v-if="(errors.first('profesional'))" >  Este dato es requerido  </p>
                          </div>

                            <hr>
                            <div class="form-group col-12" v-if="form.profesional==='Si'">
                              <label class="links">Nombre de la empresa</label>
                              <input v-model="form.nombre_empresa" v-validate="'required'" name="nombre_empresa" type="text" class="form-control" id="" placeholder="" :disabled="form.status ===! 'Pendiente'">
                              <p class="text-danger my-1" v-if="(errors.first('nombre_empresa'))" >  Este dato es requerido  </p>
                            </div>
                            <div class="form-group col-6" v-if="form.profesional==='Si'">
                              <label class="links">Teléfono empresa</label>
                              <input v-model="form.telefono_empresa" v-validate="'required'" name="telefono_empresa" type="text" class="form-control" id="" placeholder="">
                              <p class="text-danger my-1" v-if="(errors.first('telefono_empresa'))" >  Este dato es requerido  </p>
                            </div>
                            <div class="form-group col-6" v-if="form.profesional==='Si'">
                              <label class="links">Dirección de la empresa</label>
                                  <textarea v-model="form.direccion_empresa" v-validate="'required'" name="direccion_empresa" class="form-control" id="exampleFormControlTextarea1" rows="1"></textarea>
                              <p class="text-danger my-1" v-if="(errors.first('direccion_empresa'))" >  Este dato es requerido  </p>
                            </div>
                            <div class="col-sm-12" v-if="form.profesional==='Si' && form.status==='Pendiente'">
                             <div class="form-group">
                               <label for="colFormLabelSm" class="links">Documentos de acreditación</label>
                                      <div class="col-sm-12">
                                        <div class="row ">
                                            ...
                                            <div class="col-4 spl" >
                                              <button class="btn btn-light links" type="button"  @click="uploadDocumento()">Subir archivo</button>
                                            </div>
                                         </div>
                                    </div>
                              </div>
                          ...
                          <div class="row" v-if="form.profesional==='Si'">
                            <div v-for="(img ,index) in documentos" class="card col-lg-4 col-md-6 col-sm-12 col-xs-12 m-3 pr-3 py-3 border-0" >
                                ...
                                <div class="card-body">
                                  <a  class="" @click="eliminarImagen(index)"><span class="mbri-close"></span></a>
                                </div>
                              </div>
                          </div>
                        </div>
                 ...
                 eliminarImagen(index){
                   Swal({
                     ...
                     if (result.value) {
                       ...
                       data.append('id',this.documentos[index].id);
                         axios.post('index.php/user/eliminar_documento',data)
                         .then(response => {
                           if(response) {
                             Swal(
                               '¡Eliminado!',
                  ...
                  await     axios.post('index.php/user/foto', this.form_data)
                   ...
                   validateBeforeSubmit() {
                           this.$validator.validateAll().then((result) => {
                             ...
                             if(!this.editMode){
                               axios.post('index.php/user/insertar',data)
                               .then(response => {
