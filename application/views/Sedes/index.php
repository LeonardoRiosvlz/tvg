  ...
  <div class="row">
    <div class="col-lg-12 my-2 ">
      <!-- Shopping cart table -->
        ...
        <table id="example2" class="table " v-if="verTabla">
          <thead>
            <tr>
              <th scope="col" colspan="5" class="border-0 bg-white  text-center">
                         ...
                         <div class="row">
                           <div class="col-md-6">
                             ...
                             <div class="col-sm-6">
                               <!-- textarea -->
                               <div class="form-group">
                                 <label class="links">Nombre sedes</label>
                                  <input type="text" v-model="form.nombre_sede" v-validate="'required'" name="nombre_sede" class="form-control" id="" :disabled="ver">
