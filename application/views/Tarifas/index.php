          ...
          <thead>
            <tr>
              <th scope="col" colspan="5" class="border-0 bg-white  text-center">
                  <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold links">Tarifas <i class="fa fa-usd" aria-hidden="true"></i></div>
              </th>
            </tr>
            <tr>
                ...
                <div class="btn-group">
                    ...
                    <button type="button" class="btn btn-default dropdown-toggle dropdown-icon" data-toggle="dropdown">
                      ...
                      <div class="dropdown-menu" role="menu">
                        ...
                        <a class="dropdown-item" href="#" @click="eliminartarifas(index)">Eliminar</a>
                      </div>
                    </button>
                </div>
              </td>
         ...
         <div class="modal-dialog modal-xl">
           <div class="modal-content">
             <div class="modal-header">
               <h4 class="modal-title links">Tarifas <i class="fa fa-usd" aria-hidden="true"></i></h4>
               ...
               <div class="card-body">
                       ...
                       <div class="col-sm-12">
                         ...
                         <div class="col-sm-12">
                           <!-- textarea -->
                           <div class="form-group">
                             <label class="links">Precio</label>
                              <input type="text" v-model="form.precio" v-validate="'required'" name="precio" class="form-control form-control-lg" id="" :disabled="ver">
                         ...
                         <div class="col-sm-12">
                           ...
                           <div class="form-group">
                             <select v-model="form.itinerarios" v-validate="'required'"  name="itinerarios" class="form-control" :disabled="ver" >
                               <option v-for="itinerarios in itinerarios" :value="itinerarios.nombre_itinerario">{{itinerarios.nombre_itinerario}}</option>
                             </select>
                              <p class="text-danger my-1 small" v-if="(errors.first('itinerarios'))" >  Este datoes requerido  </p>
                           </div>
                         </div>
                         <div class="col-sm-12">
                           <label class="links">Tiempos de entrega</label>
                           <div class="form-group">
                             <select v-model="form.tiempos" v-validate="'required'"  name="tiempos" class="form-control" :disabled="ver" >
                              <option value=""></option>
                               <option v-for="tiempos in tiempos" :value="tiempos.nombre_tiempo">{{tiempos.nombre_tiempo}}</option>
                             </select>
     ...
     new Vue({
       ...
       methods: {
           ...
           validateBeforeSubmit() {
                 ...
                 setear(index){
                       this.form.id=this.tarifas[index].id,
                       ...
                       this.form.tipo_transporte=this.tarifas[index].tipo_transporte,
                       this.form.precio=this.tarifas[index].precio,
