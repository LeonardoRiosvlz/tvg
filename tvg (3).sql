...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-09-2020 a las 09:02:49
...
CREATE TABLE `planillas` (
  ...
  `precio_tarifa` varchar(10) NOT NULL,
  `precio_negociado` varchar(10) NOT NULL,
  `seguro` varchar(20) NOT NULL,
  `coste_guia` varchar(10) NOT NULL,
  `id_carga_c` varchar(25) NOT NULL,
  `items` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`items`)),
  `sum_volumen` varchar(20) NOT NULL,
  `sum_kilos` varchar(20) NOT NULL,
  `valor_flete` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(3581919691, 'leonardo2718', 'leonardo2718@hotmail.es', 9, '0', 0, '$2y$11$jBiNpGCqGOoPRCBws90Ih.ApWPKQeN1S/rk12.R7baSpE4jqdsS7u', NULL, NULL, NULL, '2020-09-21 07:10:15', '$2y$11$LUi1aLY/hjkFUbWQ3Q2VKOXBoz5iqPmk5XxM8JxWb26t6nG7jg.xK', '', 'Tvg', 'Cargo', '203288614', 'Jefe Administrativa y Logística', '', '', '', '2020-08-16 01:06:25', '2020-09-21 05:10:15');
