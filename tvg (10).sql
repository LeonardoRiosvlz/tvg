...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-09-2020 a las 15:50:44
...
CREATE TABLE `historial_ce` (
  ...
  `departamento_origen` varchar(15) NOT NULL,
  `ciudad_origen` varchar(15) NOT NULL,
  `dep` varchar(5) NOT NULL,
  `departamento_destino` varchar(15) NOT NULL,
  `ciudad_destino` varchar(15) NOT NULL,
  `dep_dos` varchar(5) NOT NULL,
  `tipo_transporte` int(15) NOT NULL,
  `tipo_envio` int(15) NOT NULL,
...
(3581919691, 'leonardo2718', 'leonardo2718@hotmail.es', 9, '0', 0, '$2y$11$jBiNpGCqGOoPRCBws90Ih.ApWPKQeN1S/rk12.R7baSpE4jqdsS7u', NULL, NULL, NULL, '2020-09-01 13:03:38', '$2y$11$LUi1aLY/hjkFUbWQ3Q2VKOXBoz5iqPmk5XxM8JxWb26t6nG7jg.xK', '', 'Tvg', 'Cargo', '203288614', '', '', '', '', '2020-08-16 01:06:25', '2020-09-01 11:03:38');
